...
class BuyWithFuelCardStrategyTest {
    ...
    private static final BigDecimal INCREASE = BigDecimal.valueOf(0.35);
    ...
    void testBuyWithCard_Success() {
        ...
        BigDecimal expectedPurchaseValue = data.amount().multiply(BigDecimal.ONE.add(INCREASE));
        ...
        DataBuyWithCardResponse response = buyWithFuelCardStrategy.buyWithCard(data);
    ...
    void testBuyWithCard_CardBalanceException() {
        ...
        CardBalanceException exception = assertThrows(CardBalanceException.class, () -> {
            buyWithFuelCardStrategy.buyWithCard(data);
        });
