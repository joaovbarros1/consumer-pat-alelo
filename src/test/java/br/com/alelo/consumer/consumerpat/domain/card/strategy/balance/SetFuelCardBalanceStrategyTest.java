...
class SetFuelCardBalanceStrategyTest {
    ...
    void testSetBalance_Success() {
        ...
        var cardData = new CardData(AleloServiceType.FUEL, "0000111122223333");
        ...
        Consumer result = setFuelCardBalanceStrategy.setBalance(data);
    ...
    void testSetBalance_CardNotFound() {
        ...
        SetCardBalanceStrategyException exception = assertThrows(SetCardBalanceStrategyException.class, () -> {
            setFuelCardBalanceStrategy.setBalance(data);
        });
    ...
    private DataSetBalance getDataSetBalance() {
        return new DataSetBalance(AleloServiceType.FUEL, "0000111122223333", BigDecimal.valueOf(100));
    }
}
