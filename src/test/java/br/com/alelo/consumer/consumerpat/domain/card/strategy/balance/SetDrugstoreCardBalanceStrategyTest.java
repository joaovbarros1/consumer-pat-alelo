...
class SetDrugstoreCardBalanceStrategyTest {
    ...
    void testSetBalance_Success() {
        ...
        var cardData = new CardData(AleloServiceType.DRUGSTORE, "0000111122223333");
        ...
        Consumer result = setDrugstoreCardBalanceStrategy.setBalance(data);
    ...
    void testSetBalance_CardNotFound() {
        ...
        SetCardBalanceStrategyException exception = assertThrows(SetCardBalanceStrategyException.class, () -> {
            setDrugstoreCardBalanceStrategy.setBalance(data);
        });
    ...
    private DataSetBalance getDataSetBalance() {
        return new DataSetBalance(AleloServiceType.DRUGSTORE, "0000111122223333", BigDecimal.valueOf(100));
    }
}
