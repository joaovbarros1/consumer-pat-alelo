...
@Component
public class BuyWithFoodCardStrategy implements BuyWithCardStrategy {
    ...
    private final BigDecimal DISCOUNT = BigDecimal.valueOf(0.10);
    ...
    public DataBuyWithCardResponse buyWithCard(DataBuyWithCard data) {
        try {
            ...
            /* Usando o cartão alimentação, o cliente recebe desconto de 10% */
            var multiplicationFactor = BigDecimal.ONE.subtract((DISCOUNT));
